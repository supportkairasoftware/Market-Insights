...
(function(d) { "function" === typeof require && "object" === typeof exports && "object" === typeof module ? d(require("knockout"), exports) : "function" === typeof define && define.amd ? define(["knockout", "exports"], d) : d(ko, ko.mapping = { }); })(function(d, f) {
        ...
        for (e in c)
            if (c.hasOwnProperty(e) && c[e])
                if (a = f.getType(b[e]), e && b[e] && "array" !== a && "string" !== a) y(b[e], c[e]);
                    ...
                    a = b;
                    for (var d = e, l = b[e], n = c[e], t = { }, g = l.length - 1; 0 <= g; --g) t[l[g]] = l[g];
                    for (g =
    ...
    function F(b, c, a, e, k, l, n) {
        ...
        var j = n || k, h = function() {
            ...
            d.computed = d.dependentObservable;
            return b;
        }, u = function() { return a[e] && a[e].update instanceof Function; }, v = function(b, f) {
            var g = { data: f || c, parent: j, target: d.utils.unwrapObservable(b) };
        ...
        if (t) {
            ...
            d.isObservable(b) || (b = d.observableArray([]), b.mappedRemove = function(a) {
                var c = "function" == typeof a ? a : function(b) { return b === m(a); };
                return b.remove(function(a) { return c(m(a)); });
            }, b.mappedRemoveAll = function(a) {
                var c = C(a, m);
                return b.remove(function(a) { return -1 != d.utils.arrayIndexOf(c, m(a)); });
            }, b.mappedDestroy = function(a) {
                var c = "function" == typeof a ? a : function(b) { return b === m(a); };
                return b.destroy(function(a) { return c(m(a)); });
            ...
            Q(c, function(e) {
                ...
                if (-1 == d.utils.arrayIndexOf(a.ignore, f))
                    if (-1 != d.utils.arrayIndexOf(a.copy, f)) b[e] = c[e];
                        ...
                        typeof c[e] && 0 < a.observe.length && -1 == d.utils.arrayIndexOf(a.observe, f)) b[e] = c[e], a.copiedProperties[f] = !0;
                    else {
                        var g = I.get(c[e]), k = F(b[e], c[e], a, e, b, f, b), g = g || k;
                        if (0 < a.observe.length && -1 == d.utils.arrayIndexOf(a.observe, f)) b[e] = g(), a.copiedProperties[f] = !0;
                        else {
                            if (d.isWriteableObservable(b[e])) b[e](d.utils.unwrapObservable(g));
                            else g = void 0 === b[e] ? g : d.utils.unwrapObservable(g), b[e] = g;
    ...
    function O(b, c, a) {
        for (var e = 0, d = b.length; e < d; e++) if (!0 !== a[e] && b[e] === c) return e;
        return null;
    }
    ...
    function C(b, c) {
        return d.utils.arrayMap(d.utils.unwrapObservable(b), function(a) { return c ? R(a, c) : a; });
    }
    ...
    f.visitModel = function(b, c, a) {
        ...
        if (P(k)) a = z(a, k[p]), c(b, a.parentName), e = "array" === f.getType(k) ? [] : { };
