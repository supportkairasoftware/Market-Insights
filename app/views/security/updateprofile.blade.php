@extends(((Auth::user()->RoleTypeID == 1) ? 'layouts.adminmaster' : 'layouts.sitemaster'))
			...
			<div class="panel-body">
				<div class="row">
					<form role="form" id="updateProfileform" class="form-horizontal" data-bind="with:UserModel">
                        ...
                        <div class="form-group">
							<div class="col-md-12">
                                ...
                                <div class="fileInfo" data-bind="visible:$data.FileDetails().length>0, foreach:$data.FileDetails">
                                    <div class="row-block">
										<img style="width:200px;height:200px;" data-bind="attr:{'src':FileUrl()}" />
										<!-- <br/>
											<span data-bind="visible:FileGuidName()">File Name: </span>
											
											<a  tabindex = "111" target="_blank" data-bind="attr:{'href':FileUrl()}"><span data-bind="text:FileName"></span></a>
								...
								<input  type="file" name="files" title="Upload file"  class="dz-upload btn btn-info floatLeft"  data-bind="ApplyFileUpload:$root.UploadUserImageUrl,paraMeter:$data.UserID(),
								onSuccessCallback:$root.FileUploadCompletedCallback,onErrorCallback:$root.FileUploadErrorCallback,acceptedFiles:'image'" tabindex="110" />
                        ...
                        <div class="companydetails" id="companydetailsupdate" data-bind="visible:CompanyID()>0">
                        ...
                        <label style="margin:20px 0 5px 20px;">User Details</label>
                        <div class="userdetails" id="userdetailsupdate">
						<div class="form-group">
							<div class="col-md-12">
						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<div class="col-md-8">
									<input type="text" readonly class="form-control" maxlength="50" name="Email" placeholder="Email Address" data-bind="value:Email()">
								</div>
							</div>
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	window.Required_Phone ="{{ trans('messages.PropertyRequired',array('attribute'=>'Phone'))}}";
