...
@section('Title')<?php print 'Notifications List'; ?>
@stop
@section('content')
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-inline" role="form" data-bind="with:$root.SearchModel">
                            ...
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                <select tabindex="2" class="form-control" style="width:100%" data-bind="options: $root.ActionListArray, optionsValue: 'value', optionsText: 'Action',value: Action , optionsCaption:'Select Notification Status',decorateErrorElement: Action" name="Action"></select>
                            </div>
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <button tabindex="6" type="reset"  value="Clear Filters" class="btn btn-warning btn-clear"  data-bind="click:$root.ClearSearch">Clear</button>
                            <button tabindex="5" type="submit" class="btn btn-info btn-search" id="filterBtn" class="btn btn-default" data-bind="click:$root.ApplyFilter">Search</button>
                        </form>
                    </div>
                    <div class="panel-body table-responsive ">
                        <table class="table table-bordered table-responsive-margin table-hover">
                            <thead data-bind="visible:$root.NotificationListArray().length > 0">
                            <tr data-bind="with:pager">
                                ...
                                <th  class="text-align-center width-5p">Sent</th>
                                <th  class="text-align-center">Sent Date</th>
                            </tr>
                            </thead>
                            <tbody data-bind="foreach:$root.NotificationListArray(),visible:$root.NotificationListArray().length > 0">
                            <tr>
                        ...
                        <div class="table-foot">
                            <div class="" data-bind="with:pager, visible: $data.NotificationListArray().length > 0">
...
@section('script')
    ...
    <script src="<?php echo asset('/assets/js/pagejs/admin/notificationlist.js');?>"></script>
